...
Built solo by **ymsoloranker** ([ymsoloranker](https://github.com/ymsoloranker)).
...
- 🔥 **SOLO mode** — built-in motivation, Solo Leveling, and David Goggins lines for when you need to lock back in
